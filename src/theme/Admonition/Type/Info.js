...
const defaultProps = {
    icon: <react_fontawesome_1.FontAwesomeIcon icon={free_solid_svg_icons_1.faInfoCircle}/>,
    title: (<Translate_1.default id="theme.admonition.info" description="The default label used for the Info admonition (:::info)">
      info
    </Translate_1.default>),
};
...
exports.default = AdmonitionTypeInfo;
