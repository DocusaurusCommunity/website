...
<div className='container'>
  <div className='row'>
    ...
    <div className='col col--8'>
      <div className='col-demo'>
        <CodeBlock language='jsx'>{`<Card shadow='tl'>
  <CardHeader>
    <h3>Lorem Ipsum</h3>
  </CardHeader>
  <CardBody>
            ...
            <div className='avatar avatar--vertical'>
              ...
              <div className='avatar__intro'>
                ...
                <small className='avatar__subtitle'>
                  ...
                  <a href='https://docusaurus.community/' style={{ color: 'white' }}>
        ...
        <Card shadow='tl'>
          ...
          <CardFooter style={{ backgroundColor: 'red' , color:'black'}}> 
            <div className='avatar padding-top--md'>
              ...
              <div className='avatar__intro'>
                <div className='avatar__name'>Docux (@Juniors017)</div>
                <small className='avatar__subtitle'>{'humble contributor'}</small>
              </div>
            </div>
          </CardFooter> 
        </Card>
          ...
          <CardHeader className='padding-top--lg' style={{ backgroundColor: '#87dfb8' , color:'black'}}>
            <div className='avatar avatar--vertical'>
              ...
              <div className='avatar__intro'>
                ...
                <small className='avatar__subtitle'>
                  {'humble contributor on: '}
                  <a href='https://docusaurus.community/' style={{ color: '#1a8870' }}>
                    {'docusaurus.community'}
                  </a>
                </small>
              </div>
