...
// Build the CardBody parts of component with the specified props
const CardBody = ({
  className, // classNamees personnalisées pour le composant
...
const CardImage: React.FC<CardImageProps> = ({
  ...
  return (
    <div className={clsx('card__image', className)} style={style}>
      <img src={generatedCardImageUrl} alt={alt} title={title} />
    </div>
  );
};
