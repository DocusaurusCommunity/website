...
const lightCodeTheme = prism_react_renderer_1.themes.vsLight;
const darkCodeTheme = prism_react_renderer_1.themes.vsDark;
...
const remark_plugin_npm2yarn_1 = __importDefault(require("@docusaurus/remark-plugin-npm2yarn"));
const docusaurus_remark_plugin_tab_blocks_1 = __importDefault(require("docusaurus-remark-plugin-tab-blocks"));
const remark_math_1 = __importDefault(require("remark-math"));
const rehype_katex_1 = __importDefault(require("rehype-katex"));
const remark_deflist_1 = __importDefault(require("remark-deflist"));
...
const docusaurus_plugin_plausible_1 = __importDefault(require("docusaurus-plugin-plausible"));
        ...
        [
            ...
            /** @type {import('@docusaurus/preset-classic').Options} */
            {
                docs: {
                    ...
                    editUrl: 'https://github.com/homotechsual/docusaurus.community/edit/main/',
